...
INSERT INTO `rpi` VALUES (1,'000000009ae4879e','2580',1,1,'192.168.1.103');
...
CREATE TABLE `user` (
  ...
  `Associated_User` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `user` VALUES (1,'Adrian','$2b$12$wgEuin1SYgI4nwOhoObjyOeYDQbaD21qBif4QLrX8Y7e7.FdYmvvW','Adrian','Sandoval','Member','asandovalvargas@oakland.edu',1,'0',NULL),(2,'SmartLock','$2b$12$CT3keEss.QA6qPuM8m6qP.fYiKge7DUqgoDvBE7KAjY3zCMYAn1MC','Adrian','Sandoval','Member','ertech404@gmail.com',1,'0',NULL);
...
-- Dump completed on 2020-04-12 20:07:24
