...
sudo grep -qxF '@lxterminal -e "~/Destkop/run_app.sh"' /etc/xdg/lxsession/LXDE-pi/autostart || sudo echo '@lxterminal -e "~/Destkop/run_app.sh"' >> sudo /etc/xdg/lxsession/LXDE-pi/autostart
